# GlobalCloud XiaoC 产品需求文档

## 1. 产品概述

GlobalCloud XiaoC（简称 XC，中文名小词）是面向飞书及其他业务系统的提示词工程服务。它以 wiki 体系为知识和规范来源，为飞书、XGD、GPC、Hermes、OpenClaw 等系统提供提示词生成、优化、测试、评估和复用能力。

产品同时支持 MCP 服务、Web 客户端、桌面客户端和浏览器扩展。MCP 形态用于嵌入外部应用系统；Web 和桌面形态用于人工编辑、验证、资产沉淀和日常提示词工程工作。

## 2. 目标用户

- AI 应用开发者
- 提示词工程师
- 飞书、XGD、GPC、Hermes、OpenClaw 等业务系统集成方
- 基于 wiki 体系维护知识、流程和操作规范的团队
- 内容创作者
- 需要与 AI 模型交互的普通用户
- 图像生成爱好者
...
- 面向飞书、XGD、GPC、Hermes、OpenClaw 等系统提供嵌入式提示词工程服务
- 支持基于 wiki 语境的提示词生成、优化和迭代
- Claude Desktop 集成
- HTTP 访问
