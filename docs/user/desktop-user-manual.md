# GlobalCloud XiaoC 桌面用户手册

## 1. 欢迎使用

欢迎使用 GlobalCloud XiaoC 桌面版！本应用旨在提供一个流畅、无障碍的提示词优化体验，让您可以专注于创造高质量的提示词，而无需担心网络配置问题。
...
3.  安装完成后，在您的桌面或应用程序列表中找到 "GlobalCloud XiaoC" 图标并启动它。
