# GlobalCloud XiaoC v2.10.2

## Summary
- Clarifies the relationship between GlobalCloud XiaoC, favorites, and Prompt Garden across the public site and MkDocs documentation.
...
## Product Updates
### Web
- Refreshes the project homepage and documentation navigation so GlobalCloud XiaoC remains the primary workspace product and Prompt Garden is presented as an external prompt-library source.
