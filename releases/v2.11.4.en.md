...
## Highlights
- GlobalCloud XiaoC can now cover two new provider paths: Grok for hosted text and image workflows, and Chrome built-in AI for eligible Chrome browser environments without requiring a remote API key.
